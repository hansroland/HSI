...
dag_after_step_50 = "Right DAG start = 1\n" ++
    ...
    "7 => [18,17] Nonvert 1 [3,2]  relPosMP\n" ++
    "8 => [19,17] Nonvert 1 [5,2]  relPosMP\n" ++
    "13 => [21,17] Nonvert 1 [4,3]  relPosMP\n" ++
    "14 => [23,17] Nonvert 1 [4,5]  relPosMP\n" ++
    "17 => [] Vertex [0.0,0.0,200.0] [4,5,3,2]  relPosP\n" ++
    "18 => [] Vertex [210.0,210.0,-10.0] [3,2,6]  relPos0\n" ++
    "19 => [] Vertex [-210.0,210.0,-10.0] [5,2,6]  relPos0\n" ++
    "20 => [18,19] Nonvert 1 [2,6]  relPos0\n" ++
    "21 => [] Vertex [210.0,-210.0,-10.0] [4,3,6]  relPos0\n" ++
    "22 => [18,21] Nonvert 1 [3,6]  relPos0\n" ++
    "23 => [] Vertex [-210.0,-210.0,-10.0] [4,5,6]  relPos0\n" ++
    "24 => [19,23] Nonvert 1 [5,6]  relPos0\n" ++
    "25 => [21,23] Nonvert 1 [4,6]  relPos0\n" ++
